                      ...
                      <div className="glassmorphic-card p-6 rounded-xl">
                        ...
                        <div className="space-y-4">
                          {selectedModel.versions.map((version) => (
                            <div key={version.id} className="glassmorphic-card p-4 rounded-xl border border-white/20 dark:border-gray-600/30">
                              ...
                              <div className="space-y-3">
                                {version.files.map((file, fileIndex) => {
                                  ...
                                  return (
                                    <div key={fileIndex} className="flex items-center justify-between p-4 bg-white/50 dark:bg-gray-700/50 rounded-lg border border-white/20 dark:border-gray-600/30">
                                      <div className="flex-1">
